        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {error && (
            <div className="bg-red-50 p-3 rounded-xl">
              ...
              {username === 'admin' && (
                <p className="text-red-300 text-[9px] text-center mt-1">Error: contraseña invalida</p>
              )}
            </div>
          )}
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button 
              ...
              className="flex-1 bg-slate-900 text-white px-4 py-3 rounded-xl text-sm font-bold hover:bg-black transition-all active:scale-[0.98] disabled:opacity-50"
            >
